package com.example.abhishek.tictactoe;
    ...
    public void imageTapped(View view){
     ...
     //  Log.i("tag is", "image number is " + myTapped.getTag().toString());
        ...
        if(myGameState[tappedimageTag] == 2) {
            ...
            // Toast message
            Toast.makeText(MainActivity.this, "This place is filled already",
                    Toast.LENGTH_SHORT).show();
        }
    }

    public void playAgain(View view){
        //   Log.i("msg", "play agin tapped");
